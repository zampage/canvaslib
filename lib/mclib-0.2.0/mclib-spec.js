...
describe('event tests', function(){
	...
	it('click a figure', function(){
		...
		evt.eventName = 'click';
		evt.pageX = 5 + document.getElementById('my-canvas').offsetLeft;
		evt.pageY = 5 + document.getElementById('my-canvas').offsetTop;
		document.getElementById('my-canvas').dispatchEvent(evt);
